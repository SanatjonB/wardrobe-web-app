        ...
        <div style="font-family:sans-serif;max-width:560px;margin:0 auto;padding:24px;">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:14px;">
            <tr>
              ...
              <td style="padding:10px 0;border-bottom:1px solid #e9e9ee;color:#0b0b0c;font-weight:600;">${escapeHtml(name)}</td>
            </tr>
            <tr>
              <td style="padding:10px 0;border-bottom:1px solid #e9e9ee;color:#4a4a52;">Email</td>
              <td style="padding:10px 0;border-bottom:1px solid #e9e9ee;color:#0b0b0c;font-weight:600;">${escapeHtml(email)}</td>
            </tr>
            ${
              subject
                ? `<tr>
              <td style="padding:10px 0;border-bottom:1px solid #e9e9ee;color:#4a4a52;">Subject</td>
              <td style="padding:10px 0;border-bottom:1px solid #e9e9ee;color:#0b0b0c;font-weight:600;">${escapeHtml(subject)}</td>
            </tr>`
                : ""
            }
          </table>
          ...
          <div style="margin-top:24px;">
            ...
            <div style="background:#f6f6f9;border-radius:10px;padding:16px;font-size:14px;color:#0b0b0c;line-height:1.6;white-space:pre-wrap;">${escapeHtml(message)}</div>
          </div>
