...
// Category list mirrored from the add-item form
const CATEGORIES = [
  "Tops",
  "Bottoms",
  "Outerwear",
...
export function WardrobeGrid({ items }: Props) {
  ...
  // Populate edit modal fields with the selected item's current values
  ...
  // Save edits to Supabase and refresh the page data
  ...
  // Delete the item from Supabase and close the modal
  ...
  // Increment the wear count by 1 for a given item
  ...
  return (
    <>
      ...
      <div className="wardrobe-grid">
          ...
          <div key={item.id} className="wardrobe-card">
            ...
            <div className="card-body">
              ...
              <div className="card-footer">
                {/* Tap to log a wear — increments the use counter instantly */}
                <button
        ...
        {/* "+ Add Item" card appears at the end of the last page */}
      ...
      {/* Inline edit modal — opens when user clicks Edit on a card */}
      {editItem && (
